...
const Detail = {
  _createDetailPage(imgId, name, address, city, description, customerReviews) {
    ...
    root.innerHTML = `
      <div class="detail-page">
        ...
        <div class="header">
          <h2>${name}</h2>
          <button type="button" class="show-more favorite">Favorite</button>
        </div>
        <div class="detail">
  ...
  async render() {
    ...
    const {pictureId, name, address, city, description, menus, customerReviews} =
      response.restaurant;
